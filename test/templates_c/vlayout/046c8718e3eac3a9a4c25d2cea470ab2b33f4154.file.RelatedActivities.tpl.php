<?php /* Smarty version Smarty-3.1.7, created on 2021-01-11 19:51:06
         compiled from "/var/www/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedActivities.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11021023045ffa7442c7e6d0-12967151%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '046c8718e3eac3a9a4c25d2cea470ab2b33f4154' => 
    array (
      0 => '/var/www/includes/runtime/../../layouts/vlayout/modules/Vtiger/RelatedActivities.tpl',
      1 => 1610394661,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11021023045ffa7442c7e6d0-12967151',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5ffa7442de31e',
  'variables' => 
  array (
    'MODULE_NAME' => 0,
    'RECORD' => 0,
...
<?php if ($_valid && !is_callable('content_5ffa7442de31e')) {function content_5ffa7442de31e($_smarty_tpl) {?>
...
<?php $_smarty_tpl->tpl_vars['MODULE_NAME'] = new Smarty_variable("Calendar", null, 0);?><div  class="summaryWidgetContainer"><div class="widget_header row-fluid"><span class="span8"><h4 class="textOverflowEllipsis"><?php echo vtranslate('Ultimos Chamados',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
?><div class="activityEntries"><?php echo $_smarty_tpl->tpl_vars['RECORD']->value['title'];?>
 <b>Ticket</b> N: <a href="index.php?module=HelpDesk&view=Detail&record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value['ticketid'];?>
"> <?php echo $_smarty_tpl->tpl_vars['RECORD']->value['ticket_no'];?>
 </a></div><hr><?php } ?><?php }else{ ?><div class="summaryWidgetContainer"><p class="textAlignCenter"><?php echo vtranslate('Nenhum Chamado aberto',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</p></div><?php }?><?php if ($_smarty_tpl->tpl_vars['PAGING_MODEL']->value->isNextPageExists()){?><div class="row-fluid"><div class="pull-right"><a href="javascript:void(0)" class="moreRecentActivities"><?php echo vtranslate('LBL_MORE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
..</a></div></div><?php }?></div></div>
<?php }} ?>