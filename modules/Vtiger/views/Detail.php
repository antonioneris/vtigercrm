...
class Vtiger_Detail_View extends Vtiger_Index_View {
	...
	function __construct() {
		...
		$this->exposeMethod('showRecentTickets');
		...
		// expose novo method getTikets
		$this->exposeMethod('getTickets');
	}
	...
	function showRecentTickets (Vtiger_Request $request) {
		$parentRecordId = $request->get('record');
		$pageNumber = $request->get('page');
		$limit = $request->get('limit');
		$moduleName = $request->getModule();
		...
		echo $viewer->view('RecentTickets.tpl', $moduleName, 'true');
	}

	// Mostrar Ultimos Tikets
	function showRecentTickts (Vtiger_Request $request) {
		$parentRecordId = $request->get('record');
		$pageNumber = $request->get('page');
		$limit = $request->get('limit');
		$moduleName = $request->getModule();
		...
		echo $viewer->view('RelatedTickets.tpl', $moduleName, 'true');
	}
